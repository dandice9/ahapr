...
class FaqSection extends Component{
  onShowFaq = (el: HTMLDivElement) => {
    (el?.querySelector(".icon"))?.classList.toggle("rotate-180");
    (el?.querySelector<HTMLDivElement>(".faq-content"))?.classList.toggle("hidden");
  }

  componentDidMount(){
    const faqs = document.querySelectorAll<HTMLDivElement>(".single-faq");
    faqs.forEach((el: HTMLDivElement) => {
      const faqBtn = el?.querySelector<HTMLButtonElement>(".faq-btn")
      faqBtn?.addEventListener("click", (this.onShowFaq).bind(this, el))
    })
  }
              ...
              <div className="-mx-4 flex flex-wrap">
                <div className="w-full px-4">
                  <div className="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
                    ...
                    <h2
                      className="mb-4 text-3xl font-bold text-black sm:text-4xl md:text-[42px]"
                    >
