...
class TeamSection extends Component{
    render(): ReactNode {
        return (<section id="team" className="pt-20 pb-10 lg:pt-[120px] lg:pb-20">
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
              ...
              <div className="wow fadeInUp mb-10" data-wow-delay=".1s">
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center">
                    <a
                      href=""
                      className="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-blue-500"
                    >
                      <svg
                        width="10"
                        height="18"
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp mb-10" data-wow-delay=".15s">
                ...
                <div className="text-center">
                  <h4 className="mb-2 text-lg font-medium text-black">Jezmin uniya</h4>
                  <p className="mb-5 text-sm font-medium text-body-color">
                    Product Designer
                  </p>
                  <div className="flex items-center justify-center">
