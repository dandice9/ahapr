...
class FeatureSection extends Component{
    ...
    render(): ReactNode {
        return (<section className="pt-20 pb-8 lg:pt-[120px] lg:pb-[70px]">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mb-12 max-w-[620px] lg:mb-20">
                ...
                <h2 className="mb-4 text-3xl font-bold text-black sm:text-4xl md:text-[42px]">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
                <div className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-blue-500">
                  <span className="absolute top-0 left-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-2xl bg-blue-500 bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                ...
                <a href="" className="text-base font-medium text-body-color hover:text-blue-500">
                  Learn More
                </a>
              </div>
            </div>
